    ...
    let body = {
       ...
       "effctv_dt": (new Date(this.fppgComponent.fppgformgrp.value.FCfppgEffectiveDate)).toISOString(),
        ...
        "fppi": {
          ...
          "effctv_dt_action": "string",
          "grp_situs_state_action": "string",
          "agnt_sig_txt_1": "string",
          "agnt_sig_txt_1_action": "string",
          "user_token_action": "string",
          "case_token_action": "string",
          "emp_ProductCode": "string",
          "sp_ProductCode": "string",
          "ch_ProductCode": "string",
          "emp_waiver_of_prem": "string",
          "sp_waiver_of_prem": "string",
          "emp_quality_of_life": "string",
          "sp_quality_of_life": "string",
          "emp_waiver_of_prem_action": "string",
          "sp_waiver_of_prem_action": "string",
          "emp_quality_of_life_action": "string",
          "sp_quality_of_life_action": "string",
          "emp_ProductCode_action": "string",
          "sp_ProductCode_action": "string",
          "ch_ProductCode_action": "string",
          "emp_gi_max_amt_action": "string",
