  ...
  onSubmit() {
    ...
    let body = {
      ...
      "eR_CI": {
        ...
        "emp_ProductCode_action": this.empPaidCiComponent.empCIformgrp.value.FCempCIPlanCode_Action,
        "sp_ProductCode_action": this.empPaidCiComponent.empCIformgrp.value.FCempCIPlanCode_Action,
        "ch_ProductCode_action": this.empPaidCiComponent.empCIformgrp.value.FCempCIPlanCode_Action,
        "emp_ad_bnft": "",
        "emp_ad_bnft_action": "",
        "sp_ad_bnft":"",
      ...
      "fppi": {
        ...
        "emp_ProductCode_action": this.fppComponent.fppiformgrp.value.FCfppiPlanCodeManualEntry_Action,
        "sp_ProductCode_action": this.fppComponent.fppiformgrp.value.FCfppiPlanCodeManualEntry_Action,
        "ch_ProductCode_action": this.fppComponent.fppiformgrp.value.FCfppiPlanCodeManualEntry_Action,
